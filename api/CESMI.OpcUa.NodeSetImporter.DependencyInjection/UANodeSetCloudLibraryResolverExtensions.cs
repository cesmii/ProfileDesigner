    ...
    public static class UANodeSetCloudLibraryResolverExtensions
    {
        public static IServiceCollection AddCloudLibraryResolver(this IServiceCollection services, IConfiguration configurationSection)
        {
            services
                ...
                .AddSingleton<IUANodeSetResolver, UANodeSetCloudLibraryResolver>(sp => new UANodeSetCloudLibraryResolver(sp.GetRequiredService<IOptions<UANodeSetCloudLibraryResolver.CloudLibraryOptions>>().Value));
                ;
            return services;
        }
    }
