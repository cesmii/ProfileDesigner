...
function ProfileFilter(props) {
    ...
    const [_profileFilterVal, setProfileFilterVal] = useState(null); //props.searchValue
    ...
    useEffect(() => {
        ...
        if ((props.searchCriteria == null || props.searchCriteria.filters == null) && loadingProps.refreshProfileSearchCriteria) {
        ...
        else if (props.searchCriteria.query !== _profileFilterVal) {
            setProfileFilterVal(props.searchCriteria.query);
        }
    ...
    const onSearchChange = (e) => {
        ...
        setProfileFilterVal(e.target.value);
    }
    ...
    const onSearchClick = (e) => {
        ...
        criteria.query = _profileFilterVal;
    ...
    const onClearAll = () => {
        ...
        setProfileFilterVal(criteria.query);
